...
Ядро не зависит от платформы: нужен любой MCU (или хост), у которого есть прерывание с миллисекундным периодом. Ниже - минимальный набор шагов «от нуля до мигающего светодиода».
