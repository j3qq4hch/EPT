...
Доступ к существующим структурам ept-потоков можно получить, например, создав массив из указателей на все существующие ept-потоки. Далее из этого массива возможно выбрать интересующий поток по уникальному имени, которое хранится в поле `ept->name`
```c
